...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/qr_code_scanner.svg
  SvgGenImage get qrCodeScanner =>
      const SvgGenImage('assets/icons/qr_code_scanner.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/stars_bg.png
  AssetGenImage get starsBg =>
      const AssetGenImage('assets/images/stars_bg.png');

  /// List of all assets
  List<AssetGenImage> get values => [cage, eye, starsBg];
}

class $AssetsSvgsGen {
  const $AssetsSvgsGen();

  /// File path: assets/svgs/cage.svg
  SvgGenImage get cage => const SvgGenImage('assets/svgs/cage.svg');

  /// File path: assets/svgs/eye.svg
  SvgGenImage get eye => const SvgGenImage('assets/svgs/eye.svg');

  /// List of all assets
  List<SvgGenImage> get values => [cage, eye];
}

class $AssetsVideosGen {
  const $AssetsVideosGen();

  /// File path: assets/videos/background_loop.mp4
  String get backgroundLoop => 'assets/videos/background_loop.mp4';

  /// List of all assets
  List<String> get values => [backgroundLoop];
}
